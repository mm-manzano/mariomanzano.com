/*
 * DESIGN: Quiet Luxury Editorial - Home Value Page (EDUCATIONAL ONLY)
        ...
        <div className="relative z-10 container">
          <div className="max-w-2xl">
            ...
            <h1 className="font-display text-5xl md:text-7xl font-light text-white leading-tight mb-6">
              ...
              <em className="italic">home could sell for</em>
            </h1>
            <p className="font-body text-base md:text-lg text-white/70 max-w-lg leading-relaxed">
              Before making a decision, it helps to understand what's realistic in today's market.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <RevealDiv>
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="section-number">How to Think About Value</span>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
            <RevealDiv delay={100}>
              <p className="font-body text-base md:text-lg text-[#1A1A18]/70 leading-relaxed mb-8">
                What a home can sell for depends on the property, the neighborhood, and how it's positioned.
              </p>
              <p className="font-body text-base md:text-lg text-[#1A1A18]/70 leading-relaxed mb-8">
                Most online estimates miss this because they don't account for condition, updates, or buyer behavior.
              </p>
              <p className="font-body text-base md:text-lg text-[#1A1A18]/70 leading-relaxed">
                Understanding your home's true market value requires looking at what similar homes in your specific area have actually sold for, not just what algorithms predict.
              </p>
            </RevealDiv>
              ...
              <div className="bg-[#F8F5F0] p-8 md:p-10 border border-[#E8E0D5]">
                ...
                <ul className="space-y-4">
                  {[
                    ...
                    "Current buyer demand in your market",
                    "Your home's condition and presentation",
                    "Your timeline and pricing strategy",
                  ].map((item, i) => (
        ...
        <div className="container">
          <RevealDiv className="max-w-2xl">
            ...
            <p className="font-body text-base md:text-lg text-white/70 leading-relaxed">
              Whether you're thinking about selling, considering a refinance, or simply want clarity on your home's position in the market, understanding these factors gives you the foundation to make informed decisions.
            </p>
          </RevealDiv>
        </div>
      </section>
