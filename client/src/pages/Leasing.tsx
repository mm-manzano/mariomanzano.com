...
const processSteps = [
  ...
  },
  {
    ...
    body: "Your property gets in front of tenant agents and is syndicated across AustinHomeSearch.com, HAR.com, Realtor.com, Apartments.com Network, and ListHub. Professional photography included.",
    icon: (
      <svg viewBox="0 0 24 24" className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <rect x="3" y="3" width="18" height="18" rx="2" ry="2" />
        <circle cx="8.5" cy="8.5" r="1.5" />
          ...
          <RevealDiv delay={100}>
            ...
            >
              <p className="font-body text-sm leading-relaxed" style={{ color: "#7D4A1A" }}>
                <strong style={{ color: "#7D4A1A" }}>On vacancy:</strong> With rents where they are in Cedar Park, every month a property sits empty can cost a landlord between $1,600 and $3,000 in lost rent. Better marketing and wider reach can help reduce the time your property sits vacant.
              </p>
            </div>
          </RevealDiv>
        </div>
