...
export default function Links() {
  ...
  return (
    <>
      <Helmet>
        <title>Mario Manzano | Links</title>
        <meta name="description" content="Mario Manzano — Austin Realtor & Seller Strategist. Cedar Park & Leander TX." />
      ...
      <div className="min-h-screen bg-[#1c1c1c] flex flex-col items-center justify-start px-5 py-16">
        ...
        <div className="flex flex-col items-center mb-10">
          <div className="w-10 h-10 bg-[#c9a84c] flex items-center justify-center mb-5">
            <span style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "20px", fontWeight: 600, color: "#1c1c1c", lineHeight: 1 }}>M</span>
          </div>
          <p style={{ fontFamily: "'Cormorant Garamond', serif" }} className="text-white text-3xl font-light tracking-wide">
            Mario Manzano
          </p>
          <p className="text-[#c9a84c] text-xs font-medium tracking-[0.18em] uppercase mt-1">
            Austin Realtor · Seller Strategist
          </p>
          <p className="text-white/40 text-xs tracking-wider mt-1 uppercase" style={{ letterSpacing: "0.12em" }}>
